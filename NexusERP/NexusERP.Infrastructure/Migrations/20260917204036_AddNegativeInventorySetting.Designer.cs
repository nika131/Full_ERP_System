...
namespace NexusERP.Infrastructure.Migrations
{
    ...
    [Migration("20260917204036_AddNegativeInventorySetting")]
    partial class AddNegativeInventorySetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NexusERP.Domain.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SettingValue = "5",
                            UpdatedAt = new DateTime(2026, 9, 17, 20, 40, 35, 497, DateTimeKind.Utc).AddTicks(9879)
                        });
                });
