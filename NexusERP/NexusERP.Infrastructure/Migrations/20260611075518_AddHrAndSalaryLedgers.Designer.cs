...
namespace NexusERP.Infrastructure.Migrations
{
    ...
    [Migration("20260611075518_AddHrAndSalaryLedgers")]
    partial class AddHrAndSalaryLedgers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NexusERP.Domain.Entities.UserAbsence", b =>
                {
                    ...
                    b.Property<int?>("ReviewedByUserId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexusERP.Domain.Entities.UserAbsence", b =>
                {
                    ...
                    b.HasOne("NexusERP.Domain.Entities.User", "ReviewedBy")
                        .WithMany("Absences")
                        .HasForeignKey("ReviewedByUserId1");
