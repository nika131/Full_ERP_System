    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-800 p-4 rounded-lg shadow-sm border border-slate-700 text-white">
                    <p className="text-sm font-medium text-slate-300">Quick Actions</p>
                    <button className="mt-2 text-sm font-medium text-blue-300 hover:text-blue-200">
                        View Pending Leaves →
                    </button>
                </div>
            </div>
