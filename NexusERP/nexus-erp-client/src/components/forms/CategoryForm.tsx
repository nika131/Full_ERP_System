    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 flex flex-col h-full">
      <div className="flex-1 space-y-4">
        <div>
          ...
          <input {...register('CategoryName')} className={`w-full px-3 py-2 border rounded outline-none ${errors.CategoryName ? 'border-red-500' : 'border-slate-300 focus:border-emerald-500'}`} />
